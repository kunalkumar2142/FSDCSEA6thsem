...
// const obj=require('./userfsmodule')
...
//   res.setHeader('Content-Type','application/json')
//   const data=await obj.writeData();
//     res.end(JSON.stringify({msg:data}))

// }

// else if(req.url=="/dataAsync" && req.method=="GET"){
//   res.setHeader('Content-Type','application/json')
//   const data=await obj.readFileAsync();
//   res.end(JSON.stringify({msg:data}))
// }
...
//       const status = arr.find((ele) => ele.email == userEmail);
//       res.setHeader('Content-Type','application/json');
//       if (status) {
//         res.end(JSON.stringify({msg: "Email is already registered"}));
//       } else {
//         arr.push({ name: userName, email: userEmail, password: userPassword });
...
//       res.setHeader('Content-Type','application/json');
//       res.writeHead(500);
//       res.end(JSON.stringify({ msg: 'Server error', error: err.message }));
//     }
//   });
//   return;
...
//   res.setHeader('Content-Type','application/json')
//   res.end(JSON.stringify({msg:"Hii, at/loginApi"}))
...
//   res.setHeader('Content-Type','application/json')
//   const data=await obj.deleteData();
//     res.end(JSON.stringify({msg:data}))
